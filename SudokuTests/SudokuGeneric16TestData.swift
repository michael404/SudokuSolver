...
enum TestDataGeneric16 {
    
    enum Empty {
    
        static let board = SudokuBoardGeneric<Sudoku16>(String(repeating: ".", count: 256))
    ...
    enum Easy1 {
        ...
        static let board = SudokuBoardGeneric<Sudoku16>(string)
        ...
        static let solution = SudokuBoardGeneric<Sudoku16>(solutionString)
