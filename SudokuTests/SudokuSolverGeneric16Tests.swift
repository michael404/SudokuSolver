...
class SudokuSolverGeneric16Tests: XCTestCase {
    
    func testSudokuSolverEndToEnd() {

        XCTAssertFalse(TestDataGeneric16.Easy1.board.isFullyFilled)
        XCTAssertTrue(TestDataGeneric16.Easy1.board.isValid)
        do {
            let solution = try! TestDataGeneric16.Easy1.board.findFirstSolution()
            XCTAssertTrue(solution.isValid)
            XCTAssertTrue(solution.isFullyFilled)
            XCTAssertEqual(solution.description, TestDataGeneric16.Easy1.solutionString)
        }
        
        XCTAssertFalse(TestDataGeneric16.Medium1.board.isFullyFilled)
        XCTAssertTrue(TestDataGeneric16.Medium1.board.isValid)
        do {
            let solution = try! TestDataGeneric16.Medium1.board.findFirstSolution()
            XCTAssertTrue(solution.isValid)
            XCTAssertTrue(solution.isFullyFilled)
            XCTAssertEqual(solution.description, TestDataGeneric16.Medium1.solutionString)
        }
        
        XCTAssertFalse(TestDataGeneric16.Hard1.board.isFullyFilled)
        XCTAssertTrue(TestDataGeneric16.Hard1.board.isValid)
        do {
            let solution = try! TestDataGeneric16.Hard1.board.findFirstSolution()
            XCTAssertTrue(solution.isValid)
            XCTAssertTrue(solution.isFullyFilled)
            XCTAssertEqual(solution.description, TestDataGeneric16.Hard1.solutionString)
        }
    ...
    func testFailingBoard() {
        ...
        XCTAssertThrowsError(try TestDataGeneric16.Invalid.board.findFirstSolution())
    }
    ...
    func testNumberOfSolutions() {
        XCTAssertEqual(TestDataGeneric16.Easy1.board.numberOfSolutions(), .one)
        XCTAssertEqual(TestDataGeneric16.Medium1.board.numberOfSolutions(), .one)
        XCTAssertEqual(TestDataGeneric16.Hard1.board.numberOfSolutions(), .one)
        
        XCTAssertEqual(TestDataGeneric16.Invalid.board.numberOfSolutions(), .none)
        
        XCTAssertEqual(TestDataGeneric16.MultipleSolutions.board.numberOfSolutions(), .multiple)
        XCTAssertEqual(TestDataGeneric16.Empty.board.numberOfSolutions(), .multiple)
